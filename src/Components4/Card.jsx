        ...
        <div className={`${props.grid ? "grid grid-cols-2 gap-2 max-[800px]:flex flex-col" : ""} space-y-6`}>
            {info.map((details, key) => {
                return (
                    <div
                        key={key}
                        className={`${key !== undefined && key !== null ? "hover:scale-105 duration-1500 cursor-pointer" : ""} bg-white shadow-lg p-4 rounded-md space-y-1`}
                    >
                        ...
                        <div className={`${props.grid ? "grid grid-cols-1 place-items-center space-y-1" : "min-[800px]:flex items-center justify-between"}`}>
                            ...
                            <div className="flex gap-1 max-[800px]:w-40 max-[800px]:place-self-center items-center max-[700px]:pt-2">
                                {key === 0 ? (
                                    <a
                                        href="/ghanapage"
                                        className="bg-[#0000FE] p-2 rounded-md text-white cursor-pointer max-[700px]:text-xs"
                                    >
                                        {details.apply}
                                    </a>
                                ) : (
                                    <button className="bg-[#0000FE] p-2 rounded-md text-white cursor-pointer max-[700px]:text-xs">
                                        {details.apply}
                                    </button>
                                )}
