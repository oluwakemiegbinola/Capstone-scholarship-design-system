...
let Sidebar = (props) => {
  ...
  let remove = () => {
    ...
    return (
        <div className={`${props.hello ? "max-[700px]:invisible max-[700px]:w-0" : "max-[700px]:visible"} w-80 space-y-2`}>
        <div>
          ...
          <p onClick={remove} className="text-[#0000FE] cursor-pointer">Reset Filters</p>
          </div>
          </div>

          <div className={`${show ? "" : "hidden"} grid grid-cols-2 max-[700px]:grid-cols-1 mx-5 space-y-2 gap-1`}>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">Undergraduate<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">STEM<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">Ghana<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">Closing in 30 days<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">Africa-wide Sponsorship<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
            <button className="p-2 bg-[#EBEDFF] flex items-center gap-2 text-sm w-fit">Closing in 90 days<img src="images/cancel.png" className="cursor-pointer" alt="cancel" /></button>
          </div>
        </div>
  
        <div className="mx-8 p-2 space-y-2 bg-[#F4F5FF] pb-4 ">
        <div className="flex justify-between">
          <p className="font-bold">By Study Level </p> <img src="images/down arrow.png" alt="down arrow" />
        </div>
  
        <div className="mx-4 space-y-2">
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4" /><p>Undergraduate</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Postgraduate (Master's)</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>PhD / Doctoral</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Postdoctoral Research</p></div>
        </div>
        </div>
  
        <div className="mx-8 p-2 space-y-2 bg-[#F4F5FF] pt-8 mt-8">
        <div className="flex justify-between">
        ...
        <hr/>
        <div className="mx-4 space-y-2">
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4" /><p>Computer Science</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Data Science and AI</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Cybersecurity</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Mechanical Engineering</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Electrical Engineering</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Renewable Energy</p></div>
        <div className="flex"><input type="checkbox" className="w-8 max-[700px]:w-4"  /><p>Biotechnology</p></div>
        </div>
        </div>
        <hr />
        <div className="space-y-2">
        ...
        <div className="flex items-center rounded-md bg-white">
                    ...
                    <input type="search" className="p-2 text-sm" placeholder="Search for countries"/>
